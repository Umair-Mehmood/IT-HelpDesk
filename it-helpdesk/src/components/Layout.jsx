    ...
    <div className="public-layout">
      <header className="public-layout__header">
        <Link to="/" className="public-layout__brand">
          <img src="/it-helpdesk-logo.svg" alt="" />
      ...
      <footer className="public-layout__footer">
        ...
        <span className="public-layout__sep">·</span>
        <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="platform-social-link">
          <LinkedInIcon /> Umair Mehmood
        </a>
        <span className="public-layout__sep">·</span>
        <a href={INSTAGRAM_URL} target="_blank" rel="noopener noreferrer" className="platform-social-link">
          <InstagramIcon /> @umairbuildsai
        </a>
      </footer>
    </div>
  )
